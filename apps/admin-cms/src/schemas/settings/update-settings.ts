...
const createErrorMessages = {
  ...
  maxLength: (field: string, max: number) =>
    `${field.charAt(0).toUpperCase() + field.slice(1)} must be ${max} characters or less`,
  minLength: (field: string, min: number) =>
    `${field.charAt(0).toUpperCase() + field.slice(1)} must be at least ${min} characters`,
...
export const updateSettingsSchema = z.object({
  ...
  siteDescription: z
    ...
    .max(500, {
      message: createErrorMessages.maxLength("site description", 500),
    }),
  logoImage: z
    .object({
      ...
      publicId: z
        .string()
        .min(1, { message: createErrorMessages.required("image public ID") }),
  ...
  googleMapEmbedCode: z.string().trim().optional(),
  ...
  seoMetaTitle: z
    ...
    .max(255, {
      message: createErrorMessages.maxLength("SEO meta title", 255),
    }),
  seoMetaDescription: z
    ...
    .max(500, {
      message: createErrorMessages.maxLength("SEO meta description", 500),
    }),
  seoKeywords: z
    .string()
    .trim()
