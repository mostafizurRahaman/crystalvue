    ...
    >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex justify-center mb-6">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 backdrop-blur-sm border border-primary/20">
              ...
              <Typography variant="Medium_H6" className="text-primary-foreground">
                Limited Time Offer
              </Typography>
            </div>
          </div>
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-10">
            {[
              ...
              >
                ...
                <Typography variant="Regular_H7" className="text-primary-foreground/90">
                  {feature}
                </Typography>
              </div>
            ))}
          ...
          <div className="mt-12 pt-8 border-t border-primary/20">
            <div className="flex flex-wrap justify-center items-center gap-8">
              <div className="text-center">
                <Typography variant="Bold_H3" className="text-primary-foreground">
                  500+
                </Typography>
                <Typography variant="Regular_H7" className="text-primary-foreground/80">
                  Happy Clients
                </Typography>
              </div>
              <div className="text-center">
      ...
      <div className="absolute bottom-0 left-0 right-0">
        <svg viewBox="0 0 1440 120" className="w-full h-20">
          <path d="M0,32L48,37.3C96,43,192,53,288,58.7C384,64,480,64,576,58.7C672,53,768,43,864,48C960,53,1056,75,1152,80C1248,85,1344,75,1392,69.3L1440,64L1440,120L1392,120C1344,120,1248,120,1152,120C1056,120,960,120,864,120C768,120,672,120,576,120C480,120,384,120,288,120C192,120,96,120,48,120L0,120Z" className="fill-background" />
        </svg>
      </div>
    </section>
  );
