      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        ...
        <div className="relative h-full container mx-auto px-4 flex items-center">
          <div className="max-w-4xl space-y-6">
            {/* Badge Skeleton */}
            <div className="inline-flex items-center gap-2 bg-muted/20 px-4 py-2 rounded-full">
              <div className="w-4 h-4 rounded-full bg-primary/20 animate-pulse" />
              <Skeleton className="h-6 w-24 rounded" />
            </div>

            {/* Title Skeleton */}
            <Skeleton className="h-20 sm:h-24 md:h-28 lg:h-32 w-64 sm:w-80 md:w-96 rounded-lg" />
            
            {/* Subtitle Skeleton */}
            <Skeleton className="h-8 w-48 sm:w-56 md:w-64 lg:w-80 rounded-lg" />
