  ...
  const contactCards = [
    {
      ...
      action: settings?.contactPhone ? `tel:${settings.contactPhone.replace(/\s/g, "")}` : "",
    ...
    },
    {
      ...
      action: settings?.contactWhatsApp ? `https://wa.me/${settings.contactWhatsApp.replace(/\D/g, "")}` : "",
        ...
        <div className="relative pt-32 pb-16 gradient-hero">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-card/80 backdrop-blur-sm border border-border/20 rounded-lg p-6">
